  ...
  return (
    <div className="text-center mb-16">
      <div className="mb-8">
        ...
        <p className="text-2xl text-gray-300 mb-4">AI &amp; Analytics Engineer</p>
        <div 
      ...
      <div className="flex flex-wrap justify-center gap-6 text-sm">
        <a 
          ...
          className="flex items-center gap-2 transition-colors resume-link-secondary"
        ...
        <a 
          ...
          className="flex items-center gap-2 transition-colors resume-link-accent"
          style={{ color: 'var(--secondary)' }}
        >
