      ...
      <div className="bg-gray-800/50 rounded-xl p-8 border border-gray-700 hover:border-purple-500/50 transition-all duration-300">
        <div className="flex flex-col md:flex-row md:justify-between md:items-start mb-6">
          ...
          <div className="text-right mt-4 md:mt-0">
            <div className="font-medium px-4 py-2 rounded-full border mb-2" style={{ color: 'var(--secondary)', backgroundColor: 'color-mix(in srgb, var(--secondary) 10%, transparent)', borderColor: 'color-mix(in srgb, var(--secondary) 30%, transparent)' }}>
              2018 - Jun 2024
            </div>
            <div className="font-bold text-xl" style={{ color: 'var(--secondary)' }}>GPA: 3.82</div>
          </div>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-6 pt-6 border-t border-gray-700">
          ...
          <div className="text-center p-4 bg-gray-700/30 rounded-lg">
            <div className="text-2xl font-bold mb-1" style={{ color: 'var(--secondary)' }}>3.82</div>
            <div className="text-gray-300 text-sm">Final GPA</div>
          </div>
          <div className="text-center p-4 bg-gray-700/30 rounded-lg">
            <div className="text-2xl font-bold mb-1" style={{ color: 'var(--secondary)' }}>Full-Time</div>
