    ...
    <div className="min-h-screen pt-20 px-4">
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-16">
          <h1 className="text-5xl font-bold mb-4 pb-2" style={{ color: 'var(--primary)' }}>
            Blog
          </h1>
          <p className="text-xl text-gray-400">
            Insights on data science, visualization, and making complex topics accessible
          </p>
          <div className="w-24 h-1 mx-auto mt-8" style={{ backgroundColor: 'var(--primary)' }}></div>
        </div>
        ...
        <div className="space-y-8">
          {blogPosts.map((post) => (
            <article 
              key={post.id}
              className="group bg-gray-800/50 rounded-xl p-6 border border-gray-700 hover:border-[color-mix(in_srgb,var(--primary)_50%,transparent)] transition-all duration-300 hover:shadow-xl"
            >
              ...
              <h2 className="text-2xl font-bold text-white group-hover:text-[color-mix(in_srgb,var(--primary)_80%,white)] mb-3 transition-colors">
                <Link 
                  href={post.link}
              ...
              <div className="flex justify-between items-center">
                ...
                <Link 
                  ...
                  target={post.external ? "_blank" : "_self"}
                  rel={post.external ? "noopener noreferrer" : undefined}
                  className="inline-flex items-center gap-2 font-semibold transition-colors group" style={{ color: 'var(--secondary)' }}
                >
                  Read Article
                  {post.external && (
        ...
        <div className="text-center mt-16 py-12 bg-gray-800/30 rounded-xl border border-gray-700">
          ...
          <Link 
            ...
            className="px-8 py-4 rounded-lg font-semibold transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl inline-flex items-center gap-2 text-white hover:opacity-90"
